    ...
    <>
      <SafeAreaView style={{flex: 1, backgroundColor: myColors.background}}>
        ...
        <View>
          ...
          <View
            style={{height: myHeight(0.6), backgroundColor: myColors.divider}}
          />
        </View>
        <KeyboardAwareScrollView
          ...
          <View>
            ...
            <View style={{flexDirection: 'row', alignItems: 'center'}}>
              <View
                ...
                <TextInput
                  placeholder="Vehicle Name Ex HiRoof"
                  autoCorrect={false}
                  maxLength={35}
            ...
            <View style={{flexDirection: 'row', alignItems: 'center'}}>
              <View
                ...
                <TextInput
                  placeholder="Vehicle Number Ex MKV-150"
                  autoCorrect={false}
                  maxLength={35}
                  placeholderTextColor={myColors.offColor}
                  selectionColor={myColors.primary}
          ...
          <View>
            ...
            <Spacer paddingT={myHeight(1)} />
            <TextInput
              placeholder="About yourself & services"
              multiline={true}
              autoCorrect={false}
              maxLength={100}
              numberOfLines={2}
          ...
          <View>
            ...
            <Text
              ...
              Select current routes against time at least 1
            </Text>
            <Spacer paddingT={myHeight(0.2)} />
            ...
            <CommonFaci
              fac={isInsideUni}
              setFAc={setIsInsideUni}
              name={'Available For Inside Universities'}
            />
            <Collapsible
              collapsed={!isInsideUni}
              style={{paddingStart: myWidth(3)}}>
              <Spacer paddingT={myHeight(0.2)} />
              ...
              <View style={{justifyContent: 'space-between'}}>
                {allUnies.map(it => (
                  <CommonFaciUnies name={it.name} small={true} />
                ))}
              </View>
              <View style={{flexDirection: 'row', alignItems: 'center'}}>
                <Text
            ...
            <CommonFaci
              fac={isOneRide}
              setFAc={setOneRide}
              name={'Available For One Time Ride'}
            />
            <Collapsible collapsed={!isOneRide}>
              ...
              <View
                ...
                <CommonFaciDays
                  dailyDays={oneRideDays}
                  setDailyDays={setOneRideDays}
                  name={'All'}
                />
