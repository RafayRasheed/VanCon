...
export const RequestRide = ({navigation, route}) => {
  ...
  const [pickup, setPickup] = useState(
    online ? nearest : preReq ? preReq.pickup : null,
  );
  ...
  const [pickupTime, setPickupTime] = useState(
    preReq ? preReq.pickupTime : null,
  );
  const [dropoffTime, setDropoffTime] = useState(
    preReq ? preReq.dropoffTime : null,
  );

  const [selectedDays, setSelectedDays] = useState(
    preReq ? [...preReq.selectedDays] : [],
  );
  ...
  const [instruction, setInstruction] = useState(
    preReq ? preReq.instruction : null,
  );
    ...
    if (checkData()) {
      ...
      if (online) {
        const checkDriver = it => {
          ...
          const {distance} = getDistanceFromRes(
            from,
            current ? current : {latitude: 0, longitude: 0},
          );
        ...
        const Drivers = driver
          ? checkDriver(onlineDrivers.find(it => driver.did == it.did))
            ? [driver]
            : []
        ...
        if (Drivers.length == 0) {
          ...
          disptach(
            setErrorAlert({
              ...
              Body: 'Please retry after sometime',
              Status: 0,
            }),
          );
          return;
          ...
          .then(() => {
            disptach(
              setErrorAlert({
                ...
                Body: `Request sent to ${Drivers.length} ${
            ...
            sendPushNotification(
              'New Vanpool Request',
              `You have a vanpool request from ${profile.name}`,
              10,
              tokens,
              navigate,
            );
    ...
    <>
      <SafeAreaView style={{flex: 1, backgroundColor: myColors.background}}>
        ...
        <KeyboardAwareScrollView
          ...
          {/* Pickup */}
          <View style={{}}>
            <Text style={styles.heading}>Pickup Info</Text>

            <View style={{paddingHorizontal: myWidth(2)}}>
              <Text style={styles.tesxH}>
                Enter your pickup location and timing.
              </Text>
                ...
                <>
                  ...
                  <TouchableOpacity
                    ...
                    <Text
                      ...
                      {pickupTime ? pickupTime.time : 'Time'}{' '}
                    </Text>
                    {pickupTime ? null : (
                      <Text
                        style={[
          ...
          {/* Drop-Off Info */}
          <View style={{}}>
            <Text style={styles.heading}>Drop-Off Info</Text>

            <View style={{paddingHorizontal: myWidth(2)}}>
              <Text style={styles.tesxH}>
                Enter your drop-off location and timing.
              </Text>
              <Spacer paddingT={myHeight(0.8)} />
                  ...
                  <Collapsible collapsed={!twoWay}>
                    ...
                    <TouchableOpacity
                      ...
                      <Text
                        ...
                        {dropoffTime ? dropoffTime.time : 'Time'}{' '}
                      </Text>
                      {dropoffTime ? null : (
                        <Text
                          style={[
                  ...
                  <TouchableOpacity
                    ...
                    <View
                      ...
                      <Text
                        ...
                        {'Choose drop-off same as pick-up?'}
                      </Text>
                    </View>
                  </TouchableOpacity>
                </>
          ...
          <View style={{}}>
            ...
            <View style={{paddingHorizontal: myWidth(2)}}>
              <Text style={styles.tesxH}>Enter your contact number.</Text>
              <Spacer paddingT={myHeight(0.8)} />
          ...
          {online ? (
            <>
              ...
              <View style={{}}>
                ...
                <View style={{paddingHorizontal: myWidth(2)}}>
                  <Text style={styles.tesxH}>Enter your Offer.</Text>
                  <Spacer paddingT={myHeight(0.8)} />
                  <View
                    style={[
                      styles.backItem,
        ...
        <View style={{backgroundColor: myColors.background}}>
          ...
          <TouchableOpacity
            ...
            <Text
              ...
              {online ? 'Book Now' : 'Generate Request'}
            </Text>
          </TouchableOpacity>
        ...
        {showTimeModal && (
          <CalenderDate
            ...
            showVal={showTimeModal}
            content={showTimeModal == 1 ? pickupTime : dropoffTime}
            value={checkTime}
          />
        )}
      ...
      {showLoc ? (
        <Search
          selected={showLoc == 1 ? pickup : dropoff}
